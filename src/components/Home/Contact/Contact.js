...
export default function contact() {
    return (
        <div className="Contact sectContainer">
            <div className="topContainer">
                ...
                <div>
                    <form action="mailto:brianascraig@gmail.com" method="post" encType="text/plain">
                        ...
                        <div className="inputContainer">
                            <input className="form-control" type="tel" placeholder="Phone" required/>
                        </div>
                        <div className="inputContainer">
                            <textarea name="message" id="message" cols="70" rows="5"
                                      placeholder="What can I do for you?"/>
                        </div>
                        <button className="sectBtn btn btn-lg" type="submit" >Let's Connect</button>
                    </form>
                </div>
            </div>
